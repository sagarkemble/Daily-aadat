...
const IconItem = React.memo(
  ({
    ...
    return (
      <button
        className={cn(
          "flex size-7 cursor-pointer items-center justify-center rounded-md text-popover-foreground/70 transition-colors hover:bg-muted hover:text-popover-foreground",
...
const IconPicker = React.memo(
  ({
    ...
    return (
      <div
        className={cn("w-72 rounded-lg border bg-popover shadow-md", className)}
      ...
      >
        <div className="relative px-2 pt-2">
          <Input
            ...
            autoCapitalize="off"
            spellCheck={false}
            className="border-none px-2.5 py-2 font-semibold focus-visible:ring-2"
            placeholder="Search..."
            type="text"
            value={searchQuery}
                  ...
                  (virtualRow: {
                    ...
                    return (
                      <div
                        ...
                        className="absolute top-0 left-0 grid w-full grid-cols-9"
                        style={{
